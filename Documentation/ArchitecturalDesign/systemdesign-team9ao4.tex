...
% Begin SubSection
The system is intended to make information available digitally to any device running android OS. Patients will be able to identify colour, view basic information, be notified of nearby dealerships and variety of cars they have. The user will be able to look up data including year, model and make of the car. 
% End SubSection
